        ...
        if ( !is_plugin_active($core_plugin) && !is_plugin_active($per_page_plugin)) {
            ...
            <div id="message" class="error fade notice">
                ...
                <?php if (!is_rsssl_plugin_active()) {
                    ...
                    echo printf(__("The Really Simple SSL plugin folder in the /wp-content/plugins/ directory has been renamed to %s. Therefore Really Simple SSL pro cannot work properly. To fix this you can rename the Really Simple SSL folder back to the default %s", "really-simple-ssl"),"<b>" . $dirname . "</b>" , "<b>" . "really-simple-ssl" . '</b>');
                } ?>
