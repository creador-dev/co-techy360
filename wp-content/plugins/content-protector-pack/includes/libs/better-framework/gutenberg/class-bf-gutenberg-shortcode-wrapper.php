...
class BF_Gutenberg_Shortcode_Wrapper {
	 ...
	 * @return bool
	 */
	protected static function is_gutenberg_active() {
	...
	public static function register_block( $shortcode ) {
		...
		$args = array_filter( compact( 'render_callback', 'attributes', 'editor_style' ) );
	...
	public static function sanitize_gutenberg_category( $category ) {
		...
		return sanitize_title_with_dashes( trim( $category ) );
	}
